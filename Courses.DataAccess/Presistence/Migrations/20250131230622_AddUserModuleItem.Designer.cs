...
namespace Courses.DataAccess.Migrations
{
    ...
    [Migration("20250131230622_AddUserModuleItem")]
    partial class AddUserModuleItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Courses.Business.Entities.UserModuleItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Courses.Business.Entities.UserExam", b =>
                {
                    b.HasBaseType("Courses.Business.Entities.UserModuleItem");
            ...
            modelBuilder.Entity("Courses.Business.Entities.UserExam", b =>
                {
                    ...
                    b.HasOne("Courses.Business.Entities.UserModuleItem", null)
                        .WithOne()
                        .HasForeignKey("Courses.Business.Entities.UserExam", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Courses.Business.Entities.UserLesson", b =>
                {
                    b.HasOne("Courses.Business.Entities.UserModuleItem", null)
                        .WithOne()
                        .HasForeignKey("Courses.Business.Entities.UserLesson", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
